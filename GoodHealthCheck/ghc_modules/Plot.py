...
class Plotter(object):
  ...
  def get2DHistogram(self, name, key):
    ...
    if key.startswith('PED_ON'):
      ...
      lim['ee'] = {True: {"G1": (0, 14), "G6": (0, 8), "G12": (0, 8)},
                   False: {"G1": (2000, 3750), "G6": (2000, 3750), "G12": (2000, 3750)}}
      lim['eb'] = {True: {"G1": (0, 14), "G6": (0, 10), "G12": (0, 10)},
                   False: {"G1": (1000, 3000), "G6": (1000, 3000), "G12": (1000, 3000)}}
    else:
